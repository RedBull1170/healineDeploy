...
@Component({
  selector: 'app-editar-perfil-secretaria',
  templateUrl: './editar-perfil-secretaria.component.html',
  styleUrls: ['../../../app.component.css']
})
export class EditarPerfilSecretariaComponent implements OnInit {
