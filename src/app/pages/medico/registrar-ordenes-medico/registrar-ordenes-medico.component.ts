...
@Component({
  selector: 'app-registrar-ordenes-medico',
  templateUrl: './registrar-ordenes-medico.component.html',
  styleUrls: ['../../../app.component.css']
})
export class RegistrarOrdenesMedicoComponent implements OnInit {
