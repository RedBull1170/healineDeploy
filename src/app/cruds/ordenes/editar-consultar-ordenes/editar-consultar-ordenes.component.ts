...
@Component({
  selector: 'app-editar-consultar-ordenes',
  templateUrl: './editar-consultar-ordenes.component.html',
  styleUrls: ['../../../app.component.css']
})
export class EditarConsultarOrdenesComponent implements OnInit {
